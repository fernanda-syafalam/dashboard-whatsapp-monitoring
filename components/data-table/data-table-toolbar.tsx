...
import { SearchByOptions } from '../data-table-filter/search-by';
...
export function DataTableToolbar<TData>({ table, options, isSearch, children, className, ...props }: DataTableToolbarProps<TData>) {
  if (isSearch && !options) {
